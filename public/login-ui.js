...
(function() {
  ...
  function createLoginUI() {
    const loginHTML = `
      <div id="gamehole-login-overlay" style="
        position: fixed;
        top: 0;
        left: 0;
        width: 100%;
      ...
      ">
        ...
        ">
          ...
          <button id="gamehole-login-btn" style="
            width: 100%;
            padding: 15px;
            font-size: 18px;
            font-weight: bold;
          ...
          <button id="gamehole-guest-btn" style="
            width: 100%;
            padding: 12px;
            font-size: 14px;
    ...
    // Add hover effects
    const loginBtn = document.getElementById('gamehole-login-btn');
    const guestBtn = document.getElementById('gamehole-guest-btn');
    const usernameInput = document.getElementById('gamehole-username-input');
  ...
  function removeLoginUI() {
    const overlay = document.getElementById('gamehole-login-overlay');
    if (overlay) {
