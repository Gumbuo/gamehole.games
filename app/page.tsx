...
const featuredGames: FeaturedGame[] = [
  ...
  },
  {
    ...
    tags: ["RPG", "Creature Collector", "Immutable", "Polygon", "BNB", "$CHU"],
    color: "#9b59b6",
  ...
  },
  {
    ...
    tags: ["Action", "Mining", "Immutable", "$DAR"],
    color: "#e74c3c",
  ...
  },
  {
    ...
    tags: ["Card Game", "PvP", "Immutable", "$DAR"],
    color: "#f39c12",
...
const BLOCKCHAIN_CHAINS = [
  ...
  { name: "Cardano", color: "#0033ad", tag: "Cardano" },
  { name: "Polygon", color: "#8247e5", tag: "Polygon" },
  { name: "BNB Chain", color: "#f0b90b", tag: "BNB" },
];
