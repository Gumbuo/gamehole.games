  ...
  // ── Event 2 (Active — shows on top) ──
  {
    ...
    tiers: [
      ...
      },
      {
        ...
        totalCap: "400 items",
        items: [
          { name: "Golden Potato Cake", qty: "x10", note: "$0.05 each" },
          { name: "Pumpkin Spice Cake", qty: "x10", note: "$0.05 each" },
          { name: "Carrot Cake", qty: "x10", note: "$0.05 each" },
          { name: "Grape Tart Cake", qty: "x10", note: "$0.05 each" },
          { name: "Upside-Down Tomato Cake", qty: "x10", note: "$0.05 each" },
