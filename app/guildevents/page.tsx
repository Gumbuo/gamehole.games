...
const GUILD_ACTIVITY = [
  ...
  { name: "Cmokyc",          lastSeen: "Apr 10, 2026", activity: "Harvesting & fishing on FoxHole tiles",                                                                 gold: true,  protected: false },
  { name: "Nickoloy",        lastSeen: "Apr 10, 2026", activity: "Harvesting, fishing & planting on FoxHole tiles",                                                       gold: true,  protected: false },
  ...
  { name: "NoName",          lastSeen: "Apr 10, 2026", activity: "Harvesting & fishing on FoxHole tiles",                                                                 gold: false, protected: false },
  ...
  { name: "premiu",          lastSeen: "Apr 10, 2026", activity: "Harvesting on FoxHole tiles",                                                                    gold: false, protected: false },
  { name: "Radio",           lastSeen: "Apr 10, 2026", activity: "Harvesting on FoxHole tiles",                                                                    gold: false, protected: false },
...
const EVENT3_PLAYERS = [
  {
    name: "Cmokyc",
    lastCounted: "Apr 10, 2026",
    tiers: [
      { label: "Tier A — Basic Items (5 maxed ✓)", colorIdx: 0, priceEach: 0.0005, items: [
        ...
        { name: "Grapes",        current: 870,  cap: 2000 },
        { name: "Wheat",         current: 1224, cap: 2000 },
        { name: "Tomato",        current: 893,  cap: 2000 },
        { name: "Fern",          current: 0,    cap: 2000 },
      ]},
  ...
  },
  {
    ...
    tiers: [
      { label: "Tier A — Basic Items (3 maxed ✓)", colorIdx: 0, priceEach: 0.0005, items: [
        { name: "Cotton",        current: 2000, cap: 2000 },
        { name: "Potatoes",      current: 1618, cap: 2000 },
        { name: "Red Flower",    current: 2000, cap: 2000 },
        { name: "Blue Flower",   current: 895,  cap: 2000 },
        { name: "Yellow Flower", current: 979,  cap: 2000 },
        { name: "Pumpkin",       current: 876,  cap: 2000 },
        { name: "Grapes",        current: 147,  cap: 2000 },
        { name: "Wheat",         current: 2000, cap: 2000 },
        { name: "Tomato",        current: 1762, cap: 2000 },
        { name: "Fern",          current: 1380, cap: 2000 },
      ]},
      { label: "Tier F — Fish (Passive)", colorIdx: 5, items: [
  ...
  },
  {
    ...
    tiers: [{ label: "Tier A — Basic Items", colorIdx: 0, priceEach: 0.0005, items: [
      ...
      { name: "Red Flower",    current: 0,   cap: 2000 },
      { name: "Blue Flower",   current: 0,   cap: 2000 },
      { name: "Yellow Flower", current: 2,   cap: 2000 },
      { name: "Pumpkin",       current: 0,   cap: 2000 },
      { name: "Grapes",        current: 0,   cap: 2000 },
      { name: "Wheat",         current: 60,  cap: 2000 },
      { name: "Tomato",        current: 147, cap: 2000 },
      { name: "Fern",          current: 0,   cap: 2000 },
    ]}],
    other: [
  ...
  },
  {
    ...
    tiers: [{ label: "Tier A — Basic Items", colorIdx: 0, priceEach: 0.0005, items: [
      ...
      { name: "Potatoes",      current: 6,  cap: 2000 },
      { name: "Red Flower",    current: 0,  cap: 2000 },
      { name: "Blue Flower",   current: 0,  cap: 2000 },
      { name: "Yellow Flower", current: 7,  cap: 2000 },
      { name: "Pumpkin",       current: 0,  cap: 2000 },
      { name: "Grapes",        current: 40, cap: 2000 },
      { name: "Wheat",         current: 0,  cap: 2000 },
      { name: "Tomato",        current: 0,  cap: 2000 },
      { name: "Fern",          current: 0,  cap: 2000 },
    ]}],
  ...
  },
  {
    ...
    tiers: [{ label: "Tier A — Basic Items", colorIdx: 0, priceEach: 0.0005, items: [
      { name: "Cotton",        current: 0,   cap: 2000 },
      { name: "Potatoes",      current: 298, cap: 2000 },
      { name: "Red Flower",    current: 0,   cap: 2000 },
      { name: "Blue Flower",   current: 0,   cap: 2000 },
      { name: "Yellow Flower", current: 0,   cap: 2000 },
      { name: "Pumpkin",       current: 0,   cap: 2000 },
      ...
      { name: "Wheat",         current: 0,   cap: 2000 },
      { name: "Tomato",        current: 0,   cap: 2000 },
      { name: "Fern",          current: 178, cap: 2000 },
    ]}],
    other: [],
  },
];
