  ...
  // ── Event 2 (Active — shows on top) ──
  {
    ...
    tiers: [
      ...
      },
      {
        ...
        totalCap: "400 items",
        items: [
          { name: "Golden Potato Cake", qty: "x10", note: "$0.10 each" },
          { name: "Pumpkin Spice Cake", qty: "x10", note: "$0.10 each" },
          { name: "Carrot Cake", qty: "x10", note: "$0.10 each" },
          { name: "Grape Tart Cake", qty: "x10", note: "$0.10 each" },
          { name: "Upside-Down Tomato Cake", qty: "x10", note: "$0.10 each" },
          { name: "Wheat Flour", qty: "x50", note: "$0.05 each" },
          { name: "Wine", qty: "x300", note: "$0.005 each" },
        ],
      },
      {
        name: "Tier D",
        ...
        items: [
          { name: "Wood", qty: "1k", note: "$0.01 each" },
          { name: "Stone", qty: "1k", note: "$0.001 each" },
        ],
      },
    ],
    rules: [
