  ...
  // ── Event 2 (Active — shows on top) ──
  {
    ...
    tiers: [
      ...
      },
      {
        ...
        totalCap: "420 items",
        items: [
          { name: "Golden Potato Cake", qty: "x10", note: "$0.035 each" },
          { name: "Pumpkin Spice Cake", qty: "x10", note: "$0.035 each" },
          { name: "Carrot Cake", qty: "x10", note: "$0.035 each" },
          { name: "Grape Tart Cake", qty: "x10", note: "$0.035 each" },
          { name: "Upside-Down Tomato Cake", qty: "x10", note: "$0.035 each" },
          { name: "Wheat Flour", qty: "x70", note: "$0.035 each" },
          { name: "Wine", qty: "x300", note: "$0.0025 each" },
        ],
      },
      {
        name: "Tier D",
        ...
        items: [
          { name: "Wood", qty: "1k", note: "$0.0075 each" },
          { name: "Stone", qty: "1k", note: "$0.0075 each" },
        ],
      },
    ],
    rules: [
