    ...
    tiers: [
      {
        ...
        items: [
          { name: "Cotton", qty: "2k" },
          { name: "Potatoes", qty: "2k" },
          { name: "Red Flower", qty: "2k" },
          { name: "Blue Flower", qty: "2k" },
          { name: "Yellow Flower", qty: "2k" },
          { name: "Grapes", qty: "2k" },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Pumpkin Spice Cake", qty: "x25", note: "$0.035 each" },
          { name: "Carrot Cake", qty: "x25", note: "$0.035 each" },
          { name: "Grape Tart Cake", qty: "x25", note: "$0.035 each" },
          { name: "Upside-Down Tomato Cake", qty: "x25", note: "$0.035 each" },
          { name: "Wheat Flour", qty: "x200", note: "$0.035 each" },
          { name: "Wine", qty: "x800", note: "$0.0025 each" },
        ],
      },
      {
        name: "Tier D",
