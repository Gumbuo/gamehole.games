  ...
  // ── Event 2 (Upcoming — starts March 1) ──
  {
    ...
    tiers: [
      {
        ...
        items: [
          ...
          { name: "Potatoes", qty: "1k", note: "$0.00075 each" },
          { name: "Red Flower", qty: "1k", note: "$0.00075 each" },
          { name: "Blue Flower", qty: "1k", note: "$0.00075 each" },
          { name: "Yellow Flower", qty: "1k", note: "$0.00075 each" },
        ],
      },
      {
        name: "Tier B",
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Pumpkin Spice Cake", qty: "x2", note: "$0.015 each" },
          { name: "Carrot Cake", qty: "x2", note: "$0.015 each" },
          { name: "Grape Tart Cake", qty: "x2", note: "$0.015 each" },
          { name: "Upside-Down Tomato Cake", qty: "x2", note: "$0.015 each" },
        ],
      },
      {
        name: "Tier D",
        ...
        pricePerItem: "varies",
        playerCap: "$19 max per player",
        totalCap: "2,250 items",
        items: [
    ...
    faq: [
      ...
      },
      {
        ...
        a: "~$168 across 6 players. This is the max FoxHole will pay out. If not everyone maxes every tier, the leftover rolls into a bigger pool for the next event.",
      },
    ],
  },
